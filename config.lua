...
Config.DoorLock = 'ox_doorlock'                 -- 'qb-doorlock' for qbcore's default doorlock script | 'ox_doorlock' for ox's doorlock script | any other doorlock script, implement it in server/main.lua's "mz-storerobbery:server:OpenDoor" event.
